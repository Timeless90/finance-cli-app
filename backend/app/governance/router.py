...
def build_governance_router(
    ...
    def create_run(
        ...
        return {
            ...
            "lineage": run_service.lineage(run.run_id),
        }
    ...
    def validate_run(
        ...
        try:
            run = run_service.validate(
                run_id, actor=actor.user_id, correlation_id=x_correlation_id
            )
    ...
    def register_model(
        ...
        return {
            ...
            "lifecycle": model.lifecycle.value,
        }
