...
_ROLE_PERMISSIONS: dict[Role, frozenset[Permission]] = {
    ...
    Role.TREASURY: frozenset(
        {Permission.READ_DATA, Permission.CREATE_RUN, Permission.MANAGE_SCENARIOS}
    ),
    ...
    Role.REVIEWER: frozenset(
        {Permission.READ_DATA, Permission.APPROVE_RUN, Permission.READ_AUDIT}
    ),
...
class AccessControlService:
    ...
    def require(
        ...
        *,
        ...
        if (
            company is not None
            and principal.company_scopes
            and company not in principal.company_scopes
        ):
