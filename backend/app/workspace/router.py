...
def build_workspace_router(
    ...
    def command_center_overview(
        ...
        return CommandCenterSnapshotResponse(
            ...
            liquidity=dict(snapshot.liquidity)
    ...
    @router.get(
        "/profitability/workspace", response_model=ProfitabilityWorkspaceResponse
    )
    ...
    @router.get(
        "/data-governance/workspace", response_model=DataGovernanceWorkspaceResponse
    )
    def data_governance_workspace(
        company_id: str,
        period_id: str,
        scenario_id: str,
        x_user: str = Header(...),
        ...
        return DataGovernanceWorkspaceResponse(**projection_payload(snapshot))
