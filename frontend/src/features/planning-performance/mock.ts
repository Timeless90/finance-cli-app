...
const planningPresets: Record<
  ...
  Pick<
    PlanningSnapshot,
    'activeScenario' | 'forecast' | 'statement' | 'drivers' | 'thresholds'
  >
> = {
  'local-base': {
    activeScenario: {
    ...
    drivers: [
      ...
      {
        id: 'capex',
        label: 'Capex envelope',
        value: '31.2',
        unit: '€M',
        delta: '+€1.4M',
        owner: 'Investment Control',
        status: 'OPEN',
      },
      {
        id: 'energy',
...
const performancePresets: Record<
  string,
  Omit<PerformanceSnapshot, 'context' | 'contractStatus'>
> = {
  'local-base': {
    metrics: [
      {
    ...
    anomalies: [
      {
        ...
        period: 'P08',
        kpi: 'DSO',
        observation: '+3.8σ above rolling median',
        severity: 'HIGH',
        status: 'OPEN',
      },
      {
        ...
        period: 'P07',
        kpi: 'Energy / unit',
        observation: '+2.9σ vs normalized corridor',
        severity: 'MEDIUM',
        status: 'REVIEWED',
      },
    ],
    ...
    anomalies: [
      {
        ...
        period: 'P09',
        kpi: 'Volume',
        observation: '+3.2σ above historical growth corridor',
        severity: 'MEDIUM',
        status: 'OPEN',
      },
    ],
    ...
    anomalies: [
      {
        ...
        period: 'P09',
        kpi: 'Volume',
        observation: '-4.1σ below historical demand corridor',
        severity: 'HIGH',
        status: 'OPEN',
      },
      {
        ...
        period: 'P09',
        kpi: 'DSO',
        observation: '+4.5σ above rolling median',
        severity: 'HIGH',
        status: 'OPEN',
      },
      {
        ...
        period: 'P10',
        kpi: 'Energy / unit',
        observation: '+3.7σ above normalized corridor',
        severity: 'HIGH',
        status: 'OPEN',
      },
    ],
...
export function getMockPlanningSnapshot(
  selection: WorkspaceSelection,
): PlanningSnapshot {
  const preset =
    planningPresets[selection.scenarioId] ?? planningPresets['local-base']!;
  return {
...
export function getMockPerformanceSnapshot(
  selection: WorkspaceSelection,
): PerformanceSnapshot {
  const preset =
    performancePresets[selection.scenarioId] ?? performancePresets['local-base']!;
