...
const volatility: MarketRiskSnapshot['garch']['volatility'] = [
  ...
  { index: 2, observed: 0.81, fitted: 0.8, lower: 0.6, upper: 1.0 },
  { index: 3, observed: 0.96, fitted: 0.86, lower: 0.64, upper: 1.08 },
  { index: 4, observed: 1.22, fitted: 1.04, lower: 0.78, upper: 1.3 },
  { index: 5, observed: 1.46, fitted: 1.28, lower: 0.96, upper: 1.6 },
  ...
  { index: 10, observed: 1.04, fitted: 1.0, lower: 0.75, upper: 1.25 },
...
const qq: MarketRiskSnapshot['garch']['qq'] = [
  { theoretical: -2.3, observed: -2.62 },
  { theoretical: -1.8, observed: -1.96 },
  { theoretical: -1.4, observed: -1.45 },
  { theoretical: -1.0, observed: -1.02 },
  { theoretical: -0.6, observed: -0.59 },
  { theoretical: -0.2, observed: -0.18 },
  { theoretical: 0.2, observed: 0.19 },
  { theoretical: 0.6, observed: 0.61 },
  { theoretical: 1.0, observed: 1.04 },
  { theoretical: 1.4, observed: 1.51 },
  { theoretical: 1.8, observed: 2.02 },
  { theoretical: 2.3, observed: 2.78 },
];

const regimeProbabilities: MarketRiskSnapshot['regimes']['probabilities'] = [
  { index: 1, low: 0.86, high: 0.14 },
  { index: 2, low: 0.84, high: 0.16 },
  { index: 3, low: 0.77, high: 0.23 },
  { index: 4, low: 0.48, high: 0.52 },
  { index: 5, low: 0.21, high: 0.79 },
  { index: 6, low: 0.28, high: 0.72 },
  { index: 7, low: 0.54, high: 0.46 },
  { index: 8, low: 0.71, high: 0.29 },
  { index: 9, low: 0.8, high: 0.2 },
  { index: 10, low: 0.74, high: 0.26 },
  { index: 11, low: 0.43, high: 0.57 },
  { index: 12, low: 0.16, high: 0.84 },
  { index: 13, low: 0.23, high: 0.77 },
  { index: 14, low: 0.46, high: 0.54 },
  { index: 15, low: 0.68, high: 0.32 },
  { index: 16, low: 0.82, high: 0.18 },
  { index: 17, low: 0.79, high: 0.21 },
  { index: 18, low: 0.61, high: 0.39 },
  { index: 19, low: 0.34, high: 0.66 },
  { index: 20, low: 0.41, high: 0.59 },
];
...
const base: Omit<MarketRiskSnapshot, 'context' | 'contractStatus' | 'modelLifecycle'> =
  {
      ...
      breaches: [
        {
          ...
          severity: '1.24x',
          documented: true,
          note: 'Energy supply headline shock',
        },
        {
          date: '2026-05-04',
          return: '-4.1%',
    ...
    modelComparison: [
      ...
      {
        id: 'M4',
        model: 'Regime GARCH-t',
        aic: '3,681',
        bic: '3,728',
        outOfSampleLoss: '0.77',
        varCoverage: '95.4%',
        tailFit: 'GOOD',
        status: 'CANDIDATE',
      },
    ...
    thresholds: [
      ...
      },
      {
        ...
        current: '€0.91M',
        status: 'WARNING',
        documentation: 'Review hedge ratio in next Treasury meeting',
      },
      {
        id: 'TH-REG',
        metric: 'High-vol regime probability',
        warning: '> 55%',
        breach: '> 75%',
        current: '59%',
        status: 'WARNING',
        documentation: 'Regime alert recorded; contract pending',
      },
      {
        id: 'TH-BT',
        metric: 'Undocumented VaR exceptions',
        warning: '> 0',
        breach: '> 2',
        current: '1',
        status: 'WARNING',
        documentation: 'July exception requires owner commentary',
      },
    ],
  };
...
export function getMockMarketRiskSnapshot(
  ...
  if (selection.scenarioId === 'local-downside') {
    return {
      ...
      regimes: {
        ...
        confidence: '82%',
        states: [
          { ...base.regimes.states[0]!, probability: 0.18 },
          { ...base.regimes.states[1]!, probability: 0.82 },
        ],
      },
      ...
      thresholds: base.thresholds.map((threshold) =>
        threshold.id === 'TH-VOL'
          ? { ...threshold, current: '42.8%', status: 'BREACH' }
          : threshold.id === 'TH-VAR'
            ? { ...threshold, current: '€1.31M', status: 'BREACH' }
            : threshold,
      ),
    };
  }
