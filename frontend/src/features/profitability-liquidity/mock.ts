  ...
  metrics: [
    {
      ...
      delta: '+€5.2M vs plan',
      deltaTone: 'positive',
      meta: '29.7% of revenue',
    },
    {
      id: 'ebitda',
      label: 'EBITDA AFTER ALLOCATION',
      value: '€82.4M',
      delta: '+€3.9M vs plan',
      deltaTone: 'positive',
      meta: 'allocation v6',
  ...
  segments: [
    {
      ...
      revenue: '€168.2M',
      contributionMargin: '€61.7M',
      contributionMarginPct: '36.7%',
      ebitda: '€38.4M',
      allocatedCost: '€12.9M',
      marginAtRisk: '€3.1M',
      status: 'STRONG',
    },
    {
      ...
      label: 'Core Products',
      revenue: '€214.6M',
      contributionMargin: '€58.5M',
      contributionMarginPct: '27.3%',
      ebitda: '€31.2M',
      allocatedCost: '€18.8M',
      marginAtRisk: '€5.4M',
      status: 'STRONG',
    },
    {
      ...
      label: 'Services',
      revenue: '€71.9M',
      contributionMargin: '€18.6M',
      contributionMarginPct: '25.9%',
      ebitda: '€10.7M',
      allocatedCost: '€5.2M',
      marginAtRisk: '€2.6M',
      status: 'WATCH',
    },
    {
      ...
      revenue: '€31.6M',
      contributionMargin: '€5.8M',
      contributionMarginPct: '18.4%',
      ebitda: '€2.1M',
      allocatedCost: '€3.4M',
      marginAtRisk: '€1.7M',
      status: 'CRITICAL',
...
const profitabilityDownside: Omit<ProfitabilitySnapshot, 'context' | 'contractStatus'> =
  {
    ...
    metrics: [
      ...
      },
      {
        ...
        delta: '-€9.6M vs plan',
        deltaTone: 'negative',
        meta: 'margin defense scenario',
      },
      {
        id: 'mar',
        label: 'MARGIN AT RISK',
        value: '€24.7M',
        delta: '+€13.5M exposure',
        deltaTone: 'negative',
        meta: '95% confidence',
      },
      {
    ...
    segments: profitabilityBase.segments.map((segment) =>
      segment.id === 'legacy'
        ...
        : segment.id === 'services'
          ...
          : {
              ...segment,
              marginAtRisk: segment.id === 'premium' ? '€6.4M' : '€8.9M',
              status: 'WATCH',
            },
    ),
    sensitivities: [
...
const liquidityBase: Omit<LiquiditySnapshot, 'context' | 'contractStatus'> = {
  metrics: [
    {
      ...
      delta: '+€2.4M vs plan',
      deltaTone: 'positive',
      meta: '13-week forecast',
    },
    {
      id: 'headroom',
      label: 'MIN LIQUIDITY HEADROOM',
      value: '€14.2M',
      delta: '+€1.7M vs plan',
      deltaTone: 'positive',
      meta: 'lowest weekly point',
    },
    {
      id: 'wc',
      label: 'NET WORKING CAPITAL',
      value: '€74.6M',
      delta: '+€6.1M cash tied',
      deltaTone: 'negative',
      meta: 'DSO/DIO pressure',
    },
    {
      id: 'covenant',
      label: 'COVENANT HEADROOM',
      value: '38%',
      delta: '+7pp vs warning',
      deltaTone: 'positive',
      meta: 'minimum projected',
    },
  ],
  cashForecast: {
    horizon: '13_WEEK',
    ...
    points: Array.from({ length: 13 }, (_, index) => {
      ...
      return {
        period: `W${String(week).padStart(2, '0')}`,
        opening,
        inflow,
        outflow,
        closing,
  ...
  debt: [
    ...
    },
    {
      ...
      rate: '4.20%',
      maturity: 'FY30 P03',
      committedLimit: '€74.0M',
      headroom: '€0.0M',
      status: 'NORMAL',
    },
    {
      id: 'NOTE-01',
      instrument: 'Private Placement',
      principal: '€40.0M',
      rate: '3.55%',
      maturity: 'FY28 P11',
      committedLimit: '€40.0M',
      headroom: '€0.0M',
      status: 'WATCH',
    },
  ],
  ...
  stresses: [
    ...
    {
      id: 'S-REV',
      name: 'Revenue -10% + DSO delay',
      closingCash: '€24.9M',
      headroom: '€4.9M',
      breach: false,
      mitigation: 'Collections sprint',
    },
    {
      id: 'S-REFI',
      ...
      headroom: '€1.7M',
      breach: false,
      mitigation: 'RCF draw + capex gate',
    },
    {
      id: 'S-COMB',
      ...
      headroom: '-€2.4M',
      breach: true,
      mitigation: 'Spend gate + RCF + WC actions',
    },
  ],
};
...
const liquidityDownside: Omit<LiquiditySnapshot, 'context' | 'contractStatus'> = {
  ...
  metrics: [
    ...
    },
    {
      ...
      label: 'NET WORKING CAPITAL',
      value: '€88.3M',
      delta: '+€19.8M cash tied',
      deltaTone: 'negative',
      meta: 'collections + inventory',
    },
    {
      id: 'covenant',
      label: 'COVENANT HEADROOM',
      value: '19%',
      delta: '-12pp vs warning',
      deltaTone: 'negative',
      meta: 'minimum projected',
    },
  ],
  ...
  stresses: [
    {
      id: 'S-BASE',
      name: 'Downside baseline',
      closingCash: '€24.6M',
      headroom: '€4.6M',
      breach: false,
      mitigation: 'Weekly cash governance',
    },
    {
      id: 'S-REV',
      name: 'Revenue -10% + DSO delay',
      ...
      headroom: '-€4.2M',
      breach: true,
      mitigation: 'RCF + collections sprint',
    },
    {
      id: 'S-REFI',
      name: 'Refinancing shock',
    ...
    },
    {
      ...
      headroom: '-€12.6M',
      breach: true,
      mitigation: 'Emergency liquidity plan',
    },
  ],
};

export function getMockProfitabilitySnapshot(
  selection: WorkspaceSelection,
): ProfitabilitySnapshot {
  const preset =
    selection.scenarioId === 'local-downside'
      ? profitabilityDownside
      : profitabilityBase;
  return { contractStatus: 'MOCK_CONNECTED', context: context(selection), ...preset };
}

export function getMockLiquiditySnapshot(
  selection: WorkspaceSelection,
): LiquiditySnapshot {
  const preset =
    selection.scenarioId === 'local-downside' ? liquidityDownside : liquidityBase;
  return { contractStatus: 'MOCK_CONNECTED', context: context(selection), ...preset };
}
